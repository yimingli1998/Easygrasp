...
model.load_state_dict(torch.load(os.path.join(f'experiment/20211001_122916_test/checkpoints/model_245.pth')))


model_gp = backbone_pointnet2().cuda()
model_gp = torch.nn.DataParallel(model_gp)

model_gp.load_state_dict(torch.load(os.path.join(f'experiment/20211009_160119_fine_tuning_gp/checkpoints/model_000.pth')))
